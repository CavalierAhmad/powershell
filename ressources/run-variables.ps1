$version = "1.0"
$vars = "$workspace\ressources\variables.json"
$aliases = "$workspace\ressources\aliases.ps1"
$functions = "$workspace\ressources\functions.ps1"
$tasks = "$workspace\ressources\tasklist.ps1"
$sleeptime = "60"
...
$mathbook = "C:\Users\Ahmad\OneDrive - Algonquin College\NEXUS\z~MISC\math_practice_book.pdf"
$mathbookmarks = "Ali:  PW17
Toqa: PW2
Mimo: PW2
